    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                @if(session('msg'))
                <i style="color: green;">{{session("msg")}}</i>
                @endif
                <form action="" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Full name" name="name" value="{{$errors->any()?old('name'):$user->name}}">
                    ...
                    @enderror
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Email" name="email" id="" value="{{$errors->any()?old('email'):$user->email}}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    @enderror -->
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Phone" name="phone" id="" value="{{$errors->any()?old('phone'):$user->phone}}">
                        <div class="input-group-append">
                            <div class="input-group-text">
            ...
            <div class="icheck-primary">
              ...
              <label for="agreeTerms">
               I agree to the <a href="#">terms</a>
                        ...
                        <!-- /.col -->
                        <!-- <div class="col-4"> -->
                        <button type="submit" class="btn btn-primary btn-block text-center">UpdateAccount</button>
                        <!-- </div> -->
                        <!-- /.col -->
                    </div>
                </form>
