    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                @else
                <p class="login-box-msg">Vui lòng xác thực trước khi đổi mk</p>
                @endif

                <form action="" method="post">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Email" name="email" value="{{session('data')['form_data']}}">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <!-- <div class="col-4"> -->
                            <button type="submit" class="btn btn-primary btn-block text-center">Confirm</button>
                        <!-- </div> -->
                        <!-- /.col -->
                    </div>
                </form>
